...
This repository demonstrates a clean structure for organizing an AI assistant's identity, operating principles, developer preferences, and reusable workspace documentation.
...
Never commit API keys, OAuth tokens, passwords, private keys, `.env` files, session transcripts, or personal memory to a public repository.

## License

Choose a license before distributing or reusing this repository.
